# Harris Ransom
# PyG Distributed Learning
# Dataset Partitioning Script (from PyG distributed training)
# 6/29/2024
...
from torch_geometric.distributed import Partitioner # METIS partitioner
from torch_geometric.utils import mask_to_index

# Partitions the dataset into multiple parts
...
# Determines indexes to split dataset
...
def main():
    ...
    add('--dataset', type=str, 
        choices=['ogbn-mag', 'ogbn-products', 'MovieLens', 'Reddit'],
        default='ogbn-products', help='Name of dataset')
    add('--root_dir', default='data', type=str, help='Root directory')
