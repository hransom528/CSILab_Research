...
# From PyG Distributed Training: https://pytorch-geometric.readthedocs.io/en/latest/tutorial/multi_gpu_vanilla.html
...
if __name__ == '__main__':
    ...
    world_size = torch.cuda.device_count() # Gets number of GPUs available via CUDA
